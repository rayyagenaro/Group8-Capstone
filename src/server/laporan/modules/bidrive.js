...
export const excel = {
  ...
  columns: [
    ...
    { header: 'Name',              key: 'nama_pemesan',       width: 16 }, // ✅ sesuai alias SQL
    ...
    { header: 'Driver',            key: 'driver_names',       width: 28 },
    { header: 'Kendaraan',         key: 'vehicle_plates',     width: 24 },
...
export async function preview({ db, fromYMD, toYMD }) {
  ...
  const sql = `
    SELECT
      ...
      b.created_at,
      b.updated_at,
      u.name AS nama_pemesan, -- ✅ alias benar di sini
  ...
  const rows = raw.map(r => ({
    ...r,
    status_name: statusName(r.status_id),
  }));
