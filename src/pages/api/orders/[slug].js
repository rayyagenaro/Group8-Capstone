...
  },
  ...
  bimeal: {
    from: `bimeal_bookings b 
            ...
            LEFT JOIN unit_kerja u ON u.id = b.unit_kerja_id`,  // ✅ join ke tabel unit_kerja
    tableForCount: 'bimeal_bookings b',
    userFilterColumn: 'b.user_id',
    select: `b.id, b.nama_pic, b.unit_kerja_id, 
            u.unit_kerja,                         -- ✅ ambil nama unit kerja
            b.waktu_pesanan, b.status_id, 
            s.name AS status_name, b.created_at`,
    defaultOrder: 'ORDER BY b.created_at DESC',
    pendingWhere: 'b.status_id = 1',
    approvedWhere: 'b.status_id = 2'
  },
